...
Strong recall, slight overfitting without regularization tuning

Random Forest (tuned)

~0.77

Best performance overall, robust to outliers
...
Clone this repo and open the notebook in Colab or Jupyter
...
Place training.csv and test.csv in the root directory
...
Download from: WiDS Kaggle Challenge 2024
...
Sample README templates from UTA Data Science curriculum
